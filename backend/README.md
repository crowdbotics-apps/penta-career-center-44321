...
## Project Structure
    ...
    ├── penta_career_center_44321  # Django project configurations
...
1. Clone this repo and `cd penta_career_center_44321`
...
2. Clone this repo and `cd penta_career_center_44321`
